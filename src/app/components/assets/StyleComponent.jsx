...
export const LayoutAElement = styled(Link)`
  ...
  padding: 0 20px;
  background: ${(props) =>
      props['data-direction'] === 'up'
        ? `url('/images/info/img_loc_up.webp')`
        : `url('/images/info/img_loc_under.webp')`}
...
export const LayoutAsideLink = styled(Link)`
  ...
  font-weight: 500;
  background: ${({ showmore, children_height }) =>
    showmore === 'true'
      ? children_height === 0
...
export const AppTimeButtonStyle = styled.button`
  /* background-image: ${(props) =>
    props.ico && `url('/images/main/img_${props.ico}.webp')`}; */
  display: inline-block;
...
export const AppMMOSelect = styled(AppSelect)`
  ${MMOBorder}
  background-image: ${(props) =>
    props.bg && "url('/images/main/img_new_arr_down_on.webp')"};
...
export const AppLegend = styled.div`
  ...
  .list {
    ...
    li {
      ...
      &:first-of-type {
        background-image: url(/images/main/img_cau01.webp);
      }
      &:last-of-type {
        background-image: url(/images/main/img_cau02.webp);
      }
    }
  }
  ...
  &[data-legend-index='1'] {
    .radio label {
      ...
      &:first-of-type::before {
        background-image: url(/images/main/img_ch01.webp);
      }
      &:nth-of-type(2)::before {
        background-image: url(/images/main/img_ch02.webp);
      }
      &:nth-of-type(3)::before {
        background-image: url(/images/main/img_ch03.webp);
      }
      &:nth-of-type(4)::before {
        background-image: url(/images/main/img_ch04.webp);
      }
      &:last-of-type::before {
        background-image: url(/images/main/img_ch05.webp);
      }
    }
  }
`;
...
export const AppSecondBanner = styled.div`
  ...
  .text {
    ...
    background: #fff url(/images/main/img_bg_s_02.webp) no-repeat right 24px
      bottom;
  ...
  .buttonWrap {
    ...
    button {
      ...
      &[data-type='up'] {
        background-image: url(/images/main/img_up_down_up.webp);
      }
      &[data-type='play'] {
        background-image: url(/images/main/icon_bn_stop.webp);
      }
      &[data-type='stop'] {
        background-image: url(/images/main/icon_bn_play.webp);
      }
      &[data-type='down'] {
        background-image: url(/images/main/img_up_down_down.webp);
      }
    }
  }
`;
...
export const AppBtn = styled.button`
  ...
  cursor: pointer;
  &[data-btn='left'] {
    background-image: url(/images/main/img_ban_left.webp);
  }
  &[data-btn='atop'] {
    background-image: url(/images/main/img_ban_atop.webp);
  }
  &[data-btn='auto'] {
    background-image: url(/images/main/img_ban_auto.webp);
  }
  &[data-btn='right'] {
    background-image: url(/images/main/img_ban_right.webp);
  }
`;
...
`;
export const StandbyFillColor = styled.path`
...
export const StandbyMapPath = styled(StandbyFillColor)`
  ...
  cursor: pointer;
  filter: ${(props) =>
    props.hoverConnection && 'drop-shadow(5px 5px 3px rgba(0,0,0,0.2))'};
`;
...
`;
export const StandbyInnerMapPathStyle = styled(StandbyFillColor)`
  &:hover {
...
export const StandbyMainContainer = styled.div`
  ...
  /* overflow: hidden; */
`;
export const StandbyLoopContainer = styled.div`
  position: relative;
`;
...
export const StandbyInnerDetailContainer = styled.div`
  background-image: ${(props) =>
    props.noImage
      ? ''
      : `url('/images/main/${props.regionNum}.webp'), url('/images/main/map_bg_${props.regionNum}.webp')`};
...
export const StyledbyForecastMain = styled.div`
  > svg {
...
// @ TodayAirQuality.jsx
export const TodayAirQualityInfoContainer = styled.div`
  width: 660px;
`;
...
export const TodayAirQualityInfoButton = styled.button`
  ...
  border-radius: 5px;
  background: #fff
    ${(props) => props.ico && `url('/images/main/img_${props.ico}.webp')`}
    no-repeat center;
...
export const ContentResultTap = styled.div`
  ...
  -webkit-box-shadow: ${({ selectCheck }) =>
    selectCheck && '0px 5px 5px -1px #eeeeee;'};
  box-shadow: ${({ selectCheck }) =>
    selectCheck && '0px 5px 5px -1px #eeeeee;'};
`;
...
export const ContentResultTableSpan = styled.span`
  background: ${({ effect, opacity }) =>
    effect && (opacity ? '#0f62cc80' : '#0f62cc')} !important;
  color: ${({ effect, opacity }) =>
    effect && (opacity ? '#ffffff80' : '#fff')} !important;
`;
...
export const InfoPage1ContentCharacter = styled.li`
  ...
  background-image: ${({ char }) =>
    `url(/images/info/character_0${char}.webp)`};
  border-radius: 10px;
  border: 1px solid #dcdcdc;
  overflow: hidden;
...
export const InfoPage1NuriBox = styled.div`
  ...
  border: 1px solid #dcdcdc;
  background: #f7f7f7 url(/images/info/img_sub_openapi.webp) no-repeat left 20px
    top 19px;
  border-radius: 6px;
  line-height: 21px;
  p {
...
`;
// @ realtime/page2.jsx
export const RealtimePage2ContentResultSearchBox = styled(
...
`;
export const RealtimePage2ContentResultSearchBtn = styled(
