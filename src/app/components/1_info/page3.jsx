...
export default function Page() {
  ...
  return (
    <>
      ...
      <InfoPage3ContentSubTitleWrap>
        <li>
          지도의 지역명을 클릭하면 각 지역에 해당하는 측정소 위치 정보를 조회할
          수 있습니다.
        </li>
        <li>
          조회 후 측정소명을 클릭하면 해당 측정소의 상세 정보를 조회할 수
          있습니다.
        </li>
      </InfoPage3ContentSubTitleWrap>
      <InfoPage3ContentSelectWrap>
        ...
        <InfoPage3ContentMapWrap>
          <map name="Map">
            <area
              ...
              href="#"
              onClick={mapHandle}
              coords="122,107,116,110,113,109,116,105,114,99,110,94,103,93,98,88,95,83,91,77,94,75,97,78,98,72,103,68,109,69,110,74,109,79,111,87,122,81,125,90,131,94,131,97,127,99"
              alt="인천"
            />
            <area
              title="서울특별시"
              ...
              href="#"
              onClick={mapHandle}
              coords="127,87,124,89,127,92,130,93,131,97,133,102,138,103,140,100,144,103,147,101,150,101,151,99,151,96,154,93,154,90,151,90,151,85,150,80,143,79,140,83,137,83,134,85,131,85"
              alt="서울"
            />
            <area
              title="경기도"
              ...
              href="#"
              onClick={mapHandle}
              coords="131,145,148,142,150,140,152,140,161,147,174,134,185,132,184,127,188,128,192,123,195,108,194,106,196,102,194,97,198,94,198,92,194,90,190,89,183,85,179,86,180,80,178,77,179,68,185,64,184,58,179,55,178,52,173,51,171,47,167,43,164,45,162,43,161,39,158,38,155,40,153,38,153,35,147,29,143,32,141,32,139,37,132,43,132,48,129,51,123,55,121,54,118,56,119,72,115,72,109,69,109,73,111,77,109,79,110,84,114,87,117,85,119,83,125,87,125,90,128,91,130,94,130,97,125,99,122,105,118,110,124,113,125,116,125,120,119,117,116,121,116,126,118,128,123,125,126,126,123,131,124,135"
              alt="경기"
            />
            <area
              title="강원특별자치도"
            ...
            <area
              ...
              href="#"
              onClick={mapHandle}
              coords="165,214,158,218,149,219,145,217,144,213,132,213,129,220,120,226,115,225,115,221,110,214,104,213,108,204,105,197,108,196,107,193,104,193,104,188,104,176,96,170,97,180,101,189,100,194,98,193,96,190,92,181,91,172,90,166,89,163,84,161,81,163,80,162,80,158,79,156,84,153,83,148,88,147,89,146,90,142,92,146,94,147,90,152,90,155,101,148,100,145,102,142,97,142,93,138,99,137,103,139,105,132,113,138,123,140,131,145,140,143,146,142,148,140,154,140,155,144,164,150,164,154,170,159,166,161,163,163,162,167,158,165,153,161,152,166,151,176,156,183,158,188,159,195,161,205,166,209,169,207,173,212,180,205,182,207,183,214,185,219,185,223,184,224,179,222,177,226,173,227,172,222,168,224,166,220"
              alt="충남"
            />
            <area
              title="세종특별자치시"
              ...
              href="#"
              onClick={mapHandle}
              coords="155,162,151,164,152,173,155,180,157,183,156,184,158,186,158,194,160,195,162,194,162,187,167,185,169,180,166,174,162,172,162,167,158,164"
              alt="세종"
            />
            <area
              title="대전광역시"
              ...
              href="#"
              onClick={mapHandle}
              coords="180,209,175,212,169,208,166,211,164,210,161,207,161,195,161,194,163,187,167,184,169,181,173,183,173,186,179,190,177,195,179,201"
              alt="대전"
            />
            <area
              title="경상북도"
            ...
            <area
              ...
              href="#"
              onClick={mapHandle}
              coords="136,303,128,305,126,305,121,299,114,299,113,293,115,291,117,289,120,288,122,285,128,288,134,287,135,285,138,285,139,287,141,290,142,293,147,293,145,296,145,300,140,304"
              alt="광주"
            />
            <area
              title="전라남도"
            ...
            <area
              ...
              href="#"
              onClick={mapHandle}
              coords="247,253,244,254,238,256,235,251,234,248,238,249,240,249,240,246,238,244,239,240,243,239,245,236,240,235,240,231,243,228,244,231,246,232,251,227,256,222,263,224,264,229,264,229,266,232,264,235,262,237,260,241,258,246,259,248,253,250,251,247,247,248"
              alt="대구"
            />
            <area
              title="부산광역시"
              ...
              href="#"
              onClick={mapHandle}
              coords="285,308,282,306,278,309,275,304,271,306,268,309,266,314,264,309,265,306,268,303,265,300,264,292,269,292,271,287,277,286,279,282,283,282,288,277,291,277,293,275,297,275,299,279,299,281,300,282,299,286,298,288,297,290,297,294,295,298,289,299,287,302"
              alt="부산"
            />
            <area
              title="울산광역시"
              ...
              href="#"
              onClick={mapHandle}
              coords="301,283,298,280,299,278,296,276,294,275,292,273,285,266,279,264,278,261,281,258,280,255,284,253,285,254,286,248,293,246,298,247,300,253,305,250,311,253,313,259,313,266,308,268,306,270,306,279"
              alt="울산"
            />
            <area
              title="제주특별자치도"
              ...
              href="#"
              onClick={mapHandle}
              coords="44,410,36,410,35,412,24,411,21,414,20,414,15,409,14,402,19,398,21,394,31,390,45,388,55,385,59,387,63,389,65,393,64,394,63,398,60,401,58,404,54,405,50,408"
              alt="제주"
            />
          </map>
          <div>
            <InfoPage3ContentMap
              show
              src={`/images/info/sub_map_${imgSrc}.webp`}
              alt="전체"
              useMap="#Map"
            />
          </div>
